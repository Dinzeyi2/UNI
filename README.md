...
This is a functional local creation path for Hue, Shelly, and Sonos, plus secure integration points for separately installed Matter and HomeKit controller sidecars—not universal Wi-Fi control. Zigbee/Thread radio coordination, broader context connectors, DHCP/MAC reconciliation, and spatial CSI sensing still require their own hardware or adapters and are intentionally not faked by this implementation.
